void canvasRAAPbPb_0_100_DRAA_ChHadRAA_NPJpsiRAA()
{
//=========Macro generated from canvas: canvasRAA/canvasRAA
//=========  (Sat Feb  4 00:06:09 2017) by ROOT version6.02/10
...
tex->SetNDC();
   ...
   TH1F *Graph_Graph_Graph31003 = new TH1F("Graph_Graph_Graph31003","Graph",100,4.15,32.35);
   Graph_Graph_Graph31003->SetMinimum(0.3010687);
   Graph_Graph_Graph31003->SetMaximum(0.5409264);
   Graph_Graph_Graph31003->SetDirectory(0);
   Graph_Graph_Graph31003->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph31003->SetLineColor(ci);
   Graph_Graph_Graph31003->SetLineStyle(0);
   Graph_Graph_Graph31003->SetMarkerStyle(20);
   Graph_Graph_Graph31003->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph31003->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph31003->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph31003->GetXaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph31003->GetXaxis()->SetTitleOffset(0.9);
   Graph_Graph_Graph31003->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph31003->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph31003->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph31003->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph31003->GetYaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph31003->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_Graph31003->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph31003->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph31003->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph31003->GetZaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph31003->GetZaxis()->SetTitleSize(0.06);
   ...
   TH1F *Graph_Graph_Graph41004 = new TH1F("Graph_Graph_Graph41004","Graph",100,3.045,6.705);
   Graph_Graph_Graph41004->SetMinimum(0.4019107);
   Graph_Graph_Graph41004->SetMaximum(1.019354);
   Graph_Graph_Graph41004->SetDirectory(0);
   Graph_Graph_Graph41004->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph41004->SetLineColor(ci);
   Graph_Graph_Graph41004->SetLineStyle(0);
   Graph_Graph_Graph41004->SetMarkerStyle(20);
   Graph_Graph_Graph41004->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph41004->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph41004->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph41004->GetXaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph41004->GetXaxis()->SetTitleOffset(0.9);
   Graph_Graph_Graph41004->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph41004->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph41004->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph41004->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph41004->GetYaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph41004->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_Graph41004->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph41004->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph41004->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph41004->GetZaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph41004->GetZaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph41004->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_Graph41004);
   ...
   TH1F *Graph_Graph_Graph51005 = new TH1F("Graph_Graph_Graph51005","Graph",100,2.65,6.85);
   Graph_Graph_Graph51005->SetMinimum(0.4283902);
   Graph_Graph_Graph51005->SetMaximum(0.9150718);
   Graph_Graph_Graph51005->SetDirectory(0);
   Graph_Graph_Graph51005->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph51005->SetLineColor(ci);
   Graph_Graph_Graph51005->SetLineStyle(0);
   Graph_Graph_Graph51005->SetMarkerStyle(20);
   Graph_Graph_Graph51005->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph51005->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph51005->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph51005->GetXaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph51005->GetXaxis()->SetTitleOffset(0.9);
   Graph_Graph_Graph51005->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph51005->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph51005->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph51005->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph51005->GetYaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph51005->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_Graph51005->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph51005->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph51005->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph51005->GetZaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph51005->GetZaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph51005->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_Graph51005);
   
   gre->Draw("p");
   
   Double_t Graph5_fx1006[3] = {
   3.75,
   5,
   6};
   Double_t Graph5_fy1006[3] = {
   0.7535804,
   0.6891029,
   0.5425812};
   Double_t Graph5_fex1006[3] = {
   0.75,
   0.5,
   0.5};
   Double_t Graph5_fey1006[3] = {
   0.1209346,
   0.1059286,
   0.07363414};
   gre = new TGraphErrors(3,Graph5_fx1006,Graph5_fy1006,Graph5_fex1006,Graph5_fey1006);
   gre->SetName("Graph5");
   gre->SetTitle("Graph");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph_Graph61006 = new TH1F("Graph_Graph_Graph61006","Graph",100,2.65,6.85);
   Graph_Graph_Graph61006->SetMinimum(0.4283902);
   Graph_Graph_Graph61006->SetMaximum(0.9150718);
   Graph_Graph_Graph61006->SetDirectory(0);
   Graph_Graph_Graph61006->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph61006->SetLineColor(ci);
   Graph_Graph_Graph61006->SetLineStyle(0);
   Graph_Graph_Graph61006->SetMarkerStyle(20);
   Graph_Graph_Graph61006->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph61006->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph61006->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph61006->GetXaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph61006->GetXaxis()->SetTitleOffset(0.9);
   Graph_Graph_Graph61006->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph61006->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph61006->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph61006->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph61006->GetYaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph61006->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_Graph61006->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph61006->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph61006->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_Graph61006->GetZaxis()->SetLabelSize(0.05);
   Graph_Graph_Graph61006->GetZaxis()->SetTitleSize(0.06);
   Graph_Graph_Graph61006->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_Graph61006);
...
tex->SetNDC();
   ...
   TLegendEntry *entry=leg->AddEntry("","charged hadrons |y| < 1.0","p");
   ...
   entry=leg->AddEntry("","D^{0} |y| < 1.0","p");
   ...
   entry->SetTextFont(42);
   entry->SetTextSize(0.038);
   entry=leg->AddEntry("gNuclearModification","B^{+} |y| < 2.4","p");
   entry->SetLineColor(4);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetTextFont(42);
   entry->SetTextSize(0.038);
   entry=leg->AddEntry("","nonprompt J/#psi 1.6 < |y| < 2.4 (2.76 TeV)","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry=leg->AddEntry("","nonprompt J/#psi |y| < 2.4 (2.76 TeV)","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
