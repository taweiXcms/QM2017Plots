...
//=========  (Fri Feb  3 18:54:12 2017) by ROOT version6.02/10
...
tex->SetNDC();
   ...
   TH2F *hemptyEff_copy5 = new TH2F("hemptyEff_copy5","",50,0.5,600,10,0,1.55);
   hemptyEff_copy5->SetMinimum(0);
   hemptyEff_copy5->SetMaximum(2);
   hemptyEff_copy5->SetDirectory(0);
   hemptyEff_copy5->SetStats(0);

   ci = TColor::GetColor("#000099");
   hemptyEff_copy5->SetLineColor(ci);
   hemptyEff_copy5->SetMarkerStyle(20);
   hemptyEff_copy5->GetXaxis()->SetTitle("p_{T} (GeV/c)");
   hemptyEff_copy5->GetXaxis()->CenterTitle(true);
   hemptyEff_copy5->GetXaxis()->SetLabelFont(42);
   hemptyEff_copy5->GetXaxis()->SetTitleSize(0.05);
   hemptyEff_copy5->GetXaxis()->SetTitleFont(42);
   hemptyEff_copy5->GetYaxis()->SetTitle("R_{AA}");
   hemptyEff_copy5->GetYaxis()->CenterTitle(true);
   hemptyEff_copy5->GetYaxis()->SetLabelFont(42);
   hemptyEff_copy5->GetYaxis()->SetTitleSize(0.05);
   hemptyEff_copy5->GetYaxis()->SetTitleOffset(1.1);
   hemptyEff_copy5->GetYaxis()->SetTitleFont(42);
   hemptyEff_copy5->GetZaxis()->SetLabelFont(42);
   hemptyEff_copy5->GetZaxis()->SetLabelSize(0.035);
   hemptyEff_copy5->GetZaxis()->SetTitleSize(0.035);
   hemptyEff_copy5->GetZaxis()->SetTitleFont(42);
   hemptyEff_copy5->Draw("sameaxis");
   canvasRAA->Modified();
   canvasRAA->cd();
